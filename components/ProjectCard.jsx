    ...
    >
      <div className="bg-white ">
        <img
          ...
          alt={project.title}
          className="rounded-2xl border-4  border-white mix-blend-luminosity hover:mix-blend-normal  sm:h-72 h-50 w-full object-cover"
        />
      </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-wrap gap-2">
            {project.technologies.map((tech, idx) => (
              <span
                key={idx}
                className={`backdrop-blur-sm text-white px-2 py-1 rounded-full sm:text-xs text-[0.5rem] hover:text-white hover:bg-black cursor-none ${
